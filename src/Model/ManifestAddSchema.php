...
/**
 * ManifestAddSchema Class Doc Comment
 *
 * @category Class
 * @package  KeyStack\Client
 * @author   OpenAPI Generator team
 ...
 */
class ManifestAddSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManifestAddSchema';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cacheKey'] === null) {
            $invalidProperties[] = "'cacheKey' can't be null";
        }
    ...
    {
        if (is_null($cacheKey)) {
            throw new \InvalidArgumentException('non-nullable cacheKey cannot be null');
        }
