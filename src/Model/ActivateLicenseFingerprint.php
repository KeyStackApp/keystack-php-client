...
/**
 * ActivateLicenseFingerprint Class Doc Comment
 *
 * @category Class
 * @package  KeyStack\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivateLicenseFingerprint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivateLicense_fingerprint';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pluginVersion', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pluginVersion'] === null) {
            $invalidProperties[] = "'pluginVersion' can't be null";
        }
     ...
     * Sets pluginVersion
     *
     * @param string $pluginVersion pluginVersion
     *
     * @return self
     */
    public function setPluginVersion($pluginVersion)
    {
        if (is_null($pluginVersion)) {
            throw new \InvalidArgumentException('non-nullable pluginVersion cannot be null');
        }
     ...
     * Sets phpVersion
     *
     * @param string $phpVersion phpVersion
     *
     * @return self
     */
    public function setPhpVersion($phpVersion)
    {
        if (is_null($phpVersion)) {
            throw new \InvalidArgumentException('non-nullable phpVersion cannot be null');
        }
