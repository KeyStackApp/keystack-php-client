...
/**
 * DeactivateLicenseInput Class Doc Comment
 *
 * @category Class
 * @package  KeyStack\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeactivateLicenseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeactivateLicenseInput';
    ...
    */
     ...
     * Sets activationId
     *
     * @param string $activationId Activation ID to remove
     *
     * @return self
     */
